    ...
    return (
        <div name="home" className='w-full h-[750px] bg-[#0a192f]'>
            ...
            <div className='max-w-[1000px] gap-2 mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <p className='text-[#8892b0] py-4 max-w-[700px]'>I'm a full stack web developer with 1.5 years of experience. I create successful responsive websites that are fast, easy to use, and built with best practices. The main area of my expertise is front-end development with various frameworks such as React 
